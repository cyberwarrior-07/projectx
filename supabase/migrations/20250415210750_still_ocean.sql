...
DROP POLICY IF EXISTS "authenticated_users_can_upload_videos" ON storage.objects;
DROP POLICY IF EXISTS "authenticated_users_can_update_own_videos" ON storage.objects;
DROP POLICY IF EXISTS "authenticated_users_can_delete_own_videos" ON storage.objects;
DROP POLICY IF EXISTS "public_can_read_videos" ON storage.objects;
