...
DO $$ 
BEGIN
  -- Delete all data from tables that reference profiles
  ...
  -- Now we can safely delete non-admin profiles and users
...
BEGIN
  -- Check if admin profile exists with a different ID
  SELECT id INTO v_existing_profile_id
  FROM profiles
  WHERE email = 'admin@admin.com'
  AND id != v_admin_id;

  -- If exists with different ID, update references and delete
